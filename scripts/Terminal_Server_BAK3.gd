...
func render():
	for i in range(GW*GH):
		...
		VisualServer.canvas_item_add_texture_rect_region(cell.bg_rid, cell.rect, _font, _glyph_rects[219])
		VisualServer.canvas_item_add_texture_rect_region(cell.fg_rid, cell.rect, _font, _glyph_rects[cell.glyph])
		VisualServer.canvas_item_set_modulate(cell.bg_rid, cell.bg)
		VisualServer.canvas_item_set_modulate(cell.fg_rid, cell.fg)
